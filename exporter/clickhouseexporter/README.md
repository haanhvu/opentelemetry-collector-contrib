...
`docker run --network host --name otel -p 145.40.80.230:4317:4317 -p 145.40.80.230:8888:8888 -v $(pwd)/exporter/clickhouseexporter/config.yaml:/etc/otel/config.yaml otelcontribcol`
